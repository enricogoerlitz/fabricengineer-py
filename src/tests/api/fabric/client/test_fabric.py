...
def test_initialize_fabric_client(msf_svc: MicrosoftExtraSVC):
...
def test_initialize_fabric_client_svc_from_env():
...
def test_set_global_fabric_client(msf_svc: MicrosoftExtraSVC):
    from fabricengineer.api.fabric.client.fabric import fabric_client
...
def test_get_token_with_msf_svc(msf_svc: MicrosoftExtraSVC):
...
def test_get_token_without_msf_svc_and_no_notebookutils():
...
def test_get(fabric_client: FabricAPIClient, workspace_id):
    """Test the get method."""
...
def test_get_list(fabric_client: FabricAPIClient):
    """Test the get method."""
...
def test_post_folders(fabric_client: FabricAPIClient, workspace_id):
...
def test_patch_folder(fabric_client: FabricAPIClient, workspace_id):
...
def test_delete_folder(fabric_client: FabricAPIClient, workspace_id):
